      ...
      >
        ...
        <Form.Row style={{maxHeight: '60px', marginBottom: '5px', borderWidth: '2px', borderColor: 'white' }}>
          ...
          <Form.Group as={Col} className="textFieldLabel" style={
            (targetBucket.length < 8 ? {minWidth:'55px', maxWidth:'55px'} : {minWidth:'80px', maxWidth:'130px'})
          }>
            <Form.Label style={{paddingTop:'35px', color: 'darkgrey', fontSize:"12px"}}>{`${targetBucket}/zoom`}</Form.Label>
          </Form.Group> 
